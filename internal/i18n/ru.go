...
// Строки в HTML-разметке Telegram (ParseMode=HTML): надёжнее Markdown для
// URL, подчёркиваний и сниппетов конфигов. Запрещены сырые < > & вне тегов.
var ru = map[string]string{
	...
	"step.db.title": "🗄 <b>Шаг 2. Выбор базы данных</b>\n\n" +
		"Где хранить данные бота? Переключиться можно позже из админки — миграция встроена.",
