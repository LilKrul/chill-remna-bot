...
var ru = map[string]string{
	...
	"menu.welcome":           "👋 <b>Добро пожаловать!</b>\n\nЧерез этого бота можно оформить доступ к VPN: выбрать тариф, оплатить и получить ключ для подключения за пару минут.\n\nНажмите «💳 Купить» внизу, чтобы начать.",
	"btn.buy":                "💳 Купить",
	"btn.status":             "📊 Статус",
	"btn.p2p":                "⚙️ P2P",
	"btn.emoji":              "🎨 Эмодзи",
