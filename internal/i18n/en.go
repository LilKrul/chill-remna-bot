...
var en = map[string]string{
	...
	"addsub.title":              "➕ <b>Add-on subscription (addsub)</b>\n\nStatus: %s\nTraffic B: %s\nSquads B: internal %d, external %s\n\nCreated as a second panel user (suffix <code>_addsub</code>) with its own squad and traffic. Expiry, reset strategy and device limit are inherited from the main subscription. The second link is not shown to the user.",
	"addsub.on":                 "✅ enabled",
	"addsub.off":                "⛔ disabled",
	...
	"addsub.squads_title":       "🛰 <b>Add-on squads</b>\n\nInternal: %d, External: %d\nSelected: internal %d, external %s",
