...
var en = map[string]string{
	...
	"buy.plan_btn":           "%d mo — %s",
	"buy.choose_method":      "💳 <b>How would you like to pay?</b>\n\nPick a method below — the bot will show step-by-step instructions for it.",
	...
	"pricing.title":         "💰 <b>Pricing & limits</b>\n\n💵 Base price: %s\n🔣 Currency: %s\n\n📊 Traffic limit per tariff: %s\n🖥 Device limit per tariff (HWID): %s\n♻️ Traffic reset strategy: <code>%s</code>\n\nEmpty/0 for a tariff — no limit sent (panel default is used).",
	...
	"pricing.ask_traffic_gb":     "📊 Traffic limit for %d mo — enter GB (0 = unlimited):",
	...
	"pricing.ask_strategy":       "♻️ Pick reset strategy. MONTH — monthly, WEEK — weekly, DAY — daily, NO_RESET — never (single counter for the whole period).",
	"btn.squads":                 "📡 Squads",
	...
	"pricing.ask_devices_custom": "✏️ Enter device limit (integer; 0 = reset to panel default):",
}
