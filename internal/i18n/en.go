...
var en = map[string]string{
	...
	"menu.cat_pay":           "🧩 Subscription settings",
	...
	"pricing.title":         "💰 <b>Pricing & plans</b>\n\n🔣 Currency: %s\n\n%s\n\n«🪄 Quick setup» walks you through (period → price → traffic) and saves in one go.",
